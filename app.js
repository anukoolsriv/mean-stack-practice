...
app.use(express.static(path.join(__dirname, 'public'))); // defining middleware

app.use(bodyParser.urlencoded({extended : false})); // value false means only require strings, arrays only
